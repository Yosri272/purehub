...
Route::resource('offers', 'API\OffersAPIController')->except([
    'show'
]);
...
Route::post('OTPSMS', 'API\OtpSmsAPIController@index');
...
Route::middleware('auth:api')->group(function () {
    ...
    Route::post('users/{id}', 'API\UserAPIController@update');
    Route::post('users_del/{id}', 'API\UserAPIController@destroy');
