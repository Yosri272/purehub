...
Route::get('/linkstorage', function () {
    Artisan::call('storage:link');
	 ...
	 Route::get('homee', 'yosriController@index');
   Route::get('welcome', 'yosriController@welcome');
    Route::get('invoice', 'yosriController@invoice');
    Route::get('successful', 'yosriController@successful');
    
    Route::get('checkout','yosriController@checkout' );
   // Route::get('checkout','layoutController@checkout' );
   Route::get('homee', 'yosriController@index');
    Route::get('store', 'yosriController@store');
    Route::resource('orders', 'PaymenttController');

Route::middleware('Language')->group(function () {
    Route::get('/home',"\App\Http\Controllers\languageHomeController@index");
	Route::get('/change-language/{lang}',"\App\Http\Controllers\languageHomeController@changeLang");
...
Route::middleware('auth')->group(function () {
   ...
   // Route::get('invoice', 'OrderStatusController@invoice')->name('invoice');
    ...
    Route::resource('invoice', 'OrderController');
    ...
    Route::resource('Bulk', 'BlukController')->except([
        'show'
    ]);
    ...
    Route::post('offers/remove-media','OffersController@removeMedia');
