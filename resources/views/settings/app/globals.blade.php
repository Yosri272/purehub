            ...
            <div class="row">
                ...
                <div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            {!! Form::textarea('app_short_description', setting('app_short_description'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_app_short_description_placeholder")]) !!}
                            <div class="form-text text-muted">
