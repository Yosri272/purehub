...
<!-- status_ar Field -->
<div class="form-group row ">
  {!! Form::label('status_ar', trans("lang.order_status_ar_status_ar"), ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    {!! Form::text('status_ar', null,  ['class' => 'form-control','placeholder'=>  trans("lang.order_status_ar_status_ar_placeholder")]) !!}
    <div class="form-text text-muted">
      {{ trans("lang.order_status__status_help") }}
    </div>
  </div>
</div>
</div>
