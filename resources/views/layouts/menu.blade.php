...
@can('fields.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('fields*') ? 'active' : '' }}" href="{!! route('fields.index') !!}">@if($icons)<i class="nav-icon fa fa-city"></i>@endif<p>{{trans('lang.field_plural')}}</p></a>
    </li>
@endcan
...
@can('markets.index')
    <li class="nav-item has-treeview {{ (Request::is('markets*') || Request::is('requestedMarkets*') || Request::is('galleries*') || Request::is('marketReviews*')) && !Request::is('marketsPayouts*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ (Request::is('markets*') || Request::is('requestedMarkets*') || Request::is('galleries*') || Request::is('marketReviews*')) && !Request::is('marketsPayouts*')? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fa fa-plane"></i>@endif
            ...
            @can('markets.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('requestedMarkets*') ? 'active' : '' }}" href="{!! route('requestedMarkets.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-folder"></i>@endif<p>{{trans('lang.requested_markets_plural')}}</p></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('markets*') ? 'active' : '' }}" href="{!! route('markets.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-folder"></i>@endif<p>{{trans('lang.market_plural')}}</p></a>
                </li>
            @endcan
            @can('galleries.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('galleries*') ? 'active' : '' }}" href="{!! route('galleries.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-photo-video"></i>@endif<p>{{trans('lang.gallery_plural')}}</p></a>
                </li>
            @endcan
...
@can('products.index')
    <li class="nav-item has-treeview {{ Request::is('products*') || Request::is('options*') || Request::is('optionGroups*') || Request::is('productReviews*') || Request::is('nutrition*') ? 'menu-open' : '' }}">
        ...
        <ul class="nav nav-treeview">
            ...
            @can('Bulk.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('options*') ? 'active' : '' }}" href="{!! route('Bulk.create') !!}">@if($icons)
                        <i class="nav-icon fa fa-plus-square-o"></i>@endif<p>{{trans('lang.Bulk_plural')}}</p></a>
            </li>
          @endcan
...
@endcan
 ...
 {{--@can('coupons.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('coupons*') ? 'active' : '' }}" href="{!! route('coupons.index') !!}">@if($icons)<i class="nav-icon fas fa-ticket-alt"></i>@endif<p>{{trans('lang.coupon_plural')}} <span class="right badge badge-danger">New</span></p></a>
    </li>
@endcan --}}
...
@can('medias')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('medias*') ? 'active' : '' }}" href="{!! url('medias') !!}">@if($icons)<i class="nav-icon fas fa-photo-video"></i>@endif
            ...
            @can('payments.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('payments*') ? 'active' : '' }}" href="{!! route('payments.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-credit-card"></i>@endif<p>{{trans('lang.payment_plural')}}</p></a>
                </li>
            @endcan

            @can('earnings.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('earnings*') ? 'active' : '' }}" href="{!! route('earnings.index') !!}">@if($icons)<i class="fas fa-money-bill-alt"></i>@endif<p>{{trans('lang.earning_plural')}} <span class="right badge badge-danger">New</span> </p></a>
                </li>
            @endcan

            {{-- @can('driversPayouts.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('driversPayouts*') ? 'active' : '' }}" href="{!! route('driversPayouts.index') !!}">@if($icons)<i class="nav-icon fa fa-wallet"></i>@endif<p>{{trans('lang.drivers_payout_plural')}}</p></a>
                </li>
            @endcan --}}

            @can('marketsPayouts.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('marketsPayouts*') ? 'active' : '' }}" href="{!! route('marketsPayouts.index') !!}">@if($icons)<i class="nav-icon fa fa-wallet"></i>@endif<p>{{trans('lang.markets_payout_plural')}}</p></a>
                </li>
            @endcan
    ...
    (Request::is('settings*') ||
     Request::is('users*')) && !Request::is('settings/mobile*')
        ...
        <ul class="nav nav-treeview">
            ...
            <!-- @can('taxes.index')-->
            <!--    <li class="nav-item">-->
            <!--        <a class="nav-link {{ Request::is('settings/taxes*') ? 'active' : '' }}" href="{!!  url('settings/taxes/index') !!}">@if($icons)-->
