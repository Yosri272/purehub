...
<div class="card {{ Request::is('settings/mobile*') ? '' : 'collapsed-card' }}">
    ...
    <div class="card-body p-0">
        <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
                <a href="{!! route('slides.index') !!}" class="nav-link {{  Request::is('settings/mobile/slides*') ? 'selected' : '' }}">
                    <i class="fa fa-inbox"></i> {{trans('lang.slide_plural')}} 
                </a>
                    </li>
             <li class="nav-item">
                        <a href="{!! route('offers.index') !!}" class="nav-link {{  Request::is('settings/mobile/offers*') ? 'selected' : '' }}">
                            <i class="fa fa-inbox"></i> {{trans('lang.offers_plural')}} 
                        </a>
                            </li>       
