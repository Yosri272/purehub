...
<!-- Product Id Field -->
<div class="form-group row ">
  {!! Form::label('markets_id', trans("lang.product_order_product_id"),['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    {!! Form::select('markets_id', $product, null, ['class' => 'select2 form-control']) !!}
