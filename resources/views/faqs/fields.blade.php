...
<div class="form-group row ">
  {!! Form::label('question_ar', trans("lang.faq_question_ar"), ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    {!! Form::textarea('question_ar', null, ['class' => 'form-control','placeholder'=>
     trans("lang.faq_question_ar_placeholder")  ]) !!}
    <div class="form-text text-muted">{{ trans("lang.faq_question_ar_help") }}</div>
  </div>
</div>
<!-- Answer Arabic Field -->
<div class="form-group row ">
  {!! Form::label('answer_ar', trans("lang.faq_answer_ar"), ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    {!! Form::textarea('answer_ar', null, ['class' => 'form-control','placeholder'=>
     trans("lang.faq_answer_ar_placeholder")  ]) !!}
    <div class="form-text text-muted">{{ trans("lang.faq_answer_ar_help") }}</div>
  </div>
</div>
</div>
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
