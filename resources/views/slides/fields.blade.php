...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
     ...
     <!-- Text Arabic Field -->
     <div class="form-group row ">
        {!! Form::label('text_ar', trans("lang.slide_text_ar"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::text('text_ar', null,  ['class' => 'form-control','placeholder'=>  trans("lang.slide_text_ar_placeholder")]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.slide_text_ar_help") }}
            </div>
        </div>
    </div>
