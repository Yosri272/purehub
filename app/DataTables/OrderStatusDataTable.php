...
class OrderStatusDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('updated_at',function($order_status){
    return getDateColumn($order_status,'updated_at');
})
...
[
    'data' => 'status_ar',
    'title' => trans('lang.order_status_ar_status_ar'),
...
[
  ...
  'searchable'=>false,
        ...
        if ($hasCustomField) {
            $customFieldsCollection = CustomField::where('custom_field_model', OrderStatus::class)->where('in_table', '=', true)->get();
