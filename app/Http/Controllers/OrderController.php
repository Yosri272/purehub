...
class OrderController extends Controller
{
    ...
    public function show(ProductOrderDataTable $productOrderDataTable, $id)
    {
        ...
        foreach ($order->marketsOrders as $MarketsOrder) {

                $MarketsOrder->price += $MarketsOrder->price;
            
            $subtotal += $MarketsOrder->price * $MarketsOrder->quantity;
        }
    ...
    public function edit($id)
    {
        ...
        $market = $order->marketsOrders()->first();

        $market = isset($market) ? $market->markets['market_id'] : 0;
