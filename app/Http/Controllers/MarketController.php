...
class MarketController extends Controller
{
    ...
    public function __construct(MarketRepository $marketRepo, CustomFieldRepository $customFieldRepo, UploadRepository $uploadRepo, UserRepository $userRepo, FieldRepository $fieldRepository , CategoryRepository $categoryRepo)
    {
        parent::__construct();
    ...
    public function create()
    {
       ...
       // dd($category);
        ...
        return view('markets.create')->with("customFields", isset($html) ? $html : false)->with("user", $user)->with("drivers", $drivers)->with("category", $category)->with("usersSelected", $usersSelected)->with("driversSelected", $driversSelected)->with('field', $field)->with('fieldsSelected', $fieldsSelected);
    }
    ...
    public function edit($id)
    {
        ...
        return view('markets.edit')->with('market', $market)->with("customFields", isset($html) ? $html : false)->with("user", $user)->with("drivers", $drivers)->with("usersSelected", $usersSelected)->with("driversSelected", $driversSelected)->with('field', $field)->with("category", $category)->with('fieldsSelected', $fieldsSelected);
    }
