...
private $orderRepository;
    ...
    public function __construct(ProductOrderRepository $productOrderRepo, CustomFieldRepository $customFieldRepo , MarketRepository $marketRepo
    ...
    {
        $product = $this->MarketRepository->pluck('name','id');
